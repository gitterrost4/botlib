 ...
 * TODO documentation
 */
public class MuteListener extends AbstractMessageListener<ServerConfig> {
  ...
  public void onGuildMemberJoin(GuildMemberJoinEvent event) {
    ...
    if (id.isPresent()) {
      guild().addRoleToMember(event.getMember(), guild().getRoleById(config.getMuteConfig().getMuteRoleId())).queue();
    }
  }
